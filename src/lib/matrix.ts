...
export function riskColor(level: RiskLevel): string {
  switch (level) {
    case "Bajo": return "text-accent-foreground bg-accent/30 border-accent/60";
    case "Medio": return "text-primary bg-primary/10 border-primary/30";
    case "Alto": return "text-warning-foreground bg-warning/30 border-warning/60";
    case "Crítico": return "text-destructive-foreground bg-destructive border-destructive";
  }
}
